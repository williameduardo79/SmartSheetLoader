...
namespace SmartSheetLoader.Pages
{
    public partial class Sheet:ComponentBase
    {
        ...
        public List<DataFromAssignment>? assignmentData;
        public string[] GroupedColumn = new string[] { "country" };
        protected override async Task OnInitializedAsync()
        {
            ...
            if(sheet.columns.Any(x=>x.title== "arr"))
            {
                ...
                assignmentData = JsonConvert.DeserializeObject<List<DataFromAssignment>>(jsonString);
            }
